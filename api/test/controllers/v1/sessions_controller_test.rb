...
class V1::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create" do
    post v1_sessions_url, params: { court_id: @court.id, user_contact: "you@example.com" }, as: :json
  ...
  test "presigned_download" do
    ...
    get presigned_download_v1_session_url(s.id)
    assert_response :success
    body = JSON.parse(response.body)
